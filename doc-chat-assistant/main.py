...
if __name__ == '__main__':
    ...
    save_to_db(filepath='../Data/采购招标文件.docx', collection_name='采购招标文件.docx')
    print('-' * 100)

    user_query = "电梯厅门是什么材料?"
    response = rag_chat(user_query, collection_name='采购招标文件.docx', n_results=5)
    print("response:", response)
